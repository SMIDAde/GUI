...
from schau_mir_in_die_augen.general.io_functions import replace_local_path
...
class DatasetFolder:
    ...
    def data_exists(self) -> bool:
        """ Check if data is in data_folder. If not, this could mean data is not available"""
        return os.path.exists(self.data_folder) and len(os.listdir(self.data_folder)) != 0
